...
module.exports = async function handler(req, res) {
  ...
  const systemContent = SYSTEM_PROMPT + customerContext +
    '\n\nIMPORTANTE: Responde siempre en máximo 2 frases cortas y directas, más como mucho UNA pregunta al final si el arco consultivo lo pide. Sin listas, sin puntos, sin explicaciones largas. Ve al punto.' +
